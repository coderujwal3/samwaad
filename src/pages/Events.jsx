  ...
  const upcomingEvents = [
    {
      ...
      description: 'A day-long summit featuring keynote speakers, workshops, and networking opportunities focused on modern communication trends.',
      category: 'Summit',
      attendees: 200,
    ...
    },
    {
      ...
      description: 'Master the art of public speaking with expert trainers and practical exercises.',
      category: 'Workshop',
      attendees: 50,
    ...
    },
    {
      ...
      description: 'Inter-department debate competition on contemporary social and technological issues.',
  ...
  const pastEvents = [
    {
      ...
      description: 'A celebration of diversity with performances, food, and cultural exchange.',
      attendees: 300,
      rating: 4.8
    },
    {
      ...
      description: 'Intensive leadership development program for aspiring student leaders.',
      attendees: 75,
      rating: 4.9
    },
    {
      ...
      description: 'Expert insights on how artificial intelligence is transforming communication.',
      attendees: 120,
      rating: 4.7
    }
  ];
      ...
      <section className="bg-gradient-to-br from-green-600 via-blue-600 to-purple-800 text-white py-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl mb-8 text-blue-100 max-w-3xl mx-auto leading-relaxed">
            Join us for exciting workshops, competitions, and networking opportunities that will enhance your skills and expand your horizons.
          </p>
        </div>
      </section>
            ...
            {upcomingEvents.map((event) => (
              <div key={event.id} className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                ...
                <div className="p-6">
                  ...
                  <button className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3 px-6 rounded-lg font-medium hover:from-blue-700 hover:to-purple-700 transition-all duration-200 flex items-center justify-center">
                    Register Now
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {pastEvents.map((event) => (
              <div key={event.id} className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                <h3 className="text-xl font-bold mb-3 text-gray-800">{event.title}</h3>
                <p className="text-gray-600 mb-4 leading-relaxed text-sm">{event.description}</p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center p-6 bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl hover:shadow-lg transition-all duration-300 transform hover:scale-105">
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-800">Workshops</h3>
              <p className="text-gray-600 text-sm">Skill-building sessions led by experts</p>
            </div>
            ...
            <div className="text-center p-6 bg-gradient-to-br from-green-50 to-blue-50 rounded-2xl hover:shadow-lg transition-all duration-300 transform hover:scale-105">
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-800">Competitions</h3>
              <p className="text-gray-600 text-sm">Contests to showcase your talents</p>
            </div>
            ...
            <div className="text-center p-6 bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl hover:shadow-lg transition-all duration-300 transform hover:scale-105">
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-800">Cultural Events</h3>
              <p className="text-gray-600 text-sm">Celebrating diversity and creativity</p>
            </div>
            ...
            <div className="text-center p-6 bg-gradient-to-br from-orange-50 to-red-50 rounded-2xl hover:shadow-lg transition-all duration-300 transform hover:scale-105">
              ...
              <p className="text-gray-600 text-sm">Connect with peers and professionals</p>
            </div>
          </div>
        </div>
      </section>
